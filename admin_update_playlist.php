...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="Nhập váo tiêu đề danh sách phát" value="<?= $fetch_playlist['title']; ?>" class="box">
      <p>Mô tả danh sách phát <span>*</span></p>
      <textarea name="description" class="box" required placeholder="Viết mô tả cho danh sách phát" maxlength="1000" cols="30" rows="10"><?= $fetch_playlist['description']; ?></textarea>
      ...
      <input type="submit" value="Cập nhật danh sách phát" name="submit" class="btn">
      <!--<div class="flex-btn">
   ...
   <?php
      ...
      echo '<p class="empty">Chưa có danh sách nào được thêm</p>';
   }
   ?>
