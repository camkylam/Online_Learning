...
<section class="comments">
   ...
   <h1 class="heading">Bình luận của học viên</h1>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['tutor_id'] == $tutor_id){echo 'order:-1;';} ?>">
         <div class="content"><span><?= $fetch_comment['date']; ?></span><p> - <?= $fetch_content['title']; ?> - </p><a href="admin_view_content.php?get_id=<?= $fetch_content['content_id']; ?>">Xem nội dung</a></div>
         <p class="text"><?= $fetch_comment['comment']; ?></p>
         <form action="" method="post">
            <input type="hidden" name="comment_id" value="<?= $fetch_comment['id']; ?>">
            
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('Bạn muốn xóa bình luận này?');">Xóa bình luận</button>
         </form>
      </div>
      <?php
       }
